...
$site->add_style( 'normalize', sprintf( '%s/normalize.css/normalize.css', $bower_url, [], '3.0.3' ) );
...
switch ( $site->ui_toolkit ) {
	case 'bootstrap':
		...
		$site->add_style( 'ui-toolkit', sprintf( '%s/style-%s.css', $site->theme->link, $site->ui_toolkit ), [ 'bootstrap' ] );
		break;
	...
	case 'semantic-ui':
		...
		$site->add_style( 'ui-toolkit', sprintf( '%s/style-%s.css', $site->theme->link, $site->ui_toolkit ), [ 'semantic-ui' ] );
		break;
